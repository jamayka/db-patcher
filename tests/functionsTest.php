...
class DBPatcherTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        return [
            [PatchFile::STATUS_CHANGED, PatchFile::STATUS_INSTALLED, 'mm1'],
            [PatchFile::STATUS_INSTALLED, PatchFile::STATUS_INSTALLED, 'm1'],
            [PatchFile::STATUS_ERROR, PatchFile::STATUS_ERROR, 'm1'],
            [PatchFile::STATUS_NEW, PatchFile::STATUS_ERROR, 'mm1'],
        ];
    }
    ...
    {
        $rowsFromDb = [
            'n1' => ['name' => 'n1', 'status' => PatchFile::STATUS_INSTALLED, 'md5' => 'mm1'],
            'n2' => ['name' => 'n2', 'status' => PatchFile::STATUS_ERROR, 'md5' => 'mm2']
        ];
        ...
        $this->assertEquals(
            [$patchFile1Changed, $patchFile2Changed, $patchFile3],
            getPatchesWithStatuses([$patchFile1, $patchFile2, $patchFile3], $rowsFromDb, [$factory, 'call'])
        );
    }
...
// --------------------------------------------------------------------------------------------------------------------
    ...
    public function testGetPatchFilesCallsFactoryMethodAndReturnsListOfPatchFiles()
    {
        ...
        $result = getPatchFiles(['n1', 'n2'], 'baseDir', [$m, 'invoke']);
